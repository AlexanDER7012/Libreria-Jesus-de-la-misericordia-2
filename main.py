...
origins = [
    "http://localhost",
    "http://localhost:8000",   # la propia API, por si el frontend se sirve desde aquí mismo
    "http://127.0.0.1:8000",
    "http://localhost:5500",   # Live Server (VS Code) - puerto por defecto
    "http://127.0.0.1:5500",
    "http://localhost:3000",   # por si en algún momento usan algo tipo Node/Vite
]
