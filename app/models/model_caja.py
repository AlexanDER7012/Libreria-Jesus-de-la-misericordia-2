"""
app/models/model_caja.py
---------------------------
Tablas: tipo_pago, tipo_gasto, gasto, caja_turno, caja_denominacion,
...
class CajaTurno(Base):
    ...
    fondo_inicial = Column(DECIMAL(12, 2), default=500.00)  # Q500 por defecto
